    ...
    public class JwtFactory : IJwtFactory
    {
        ...
        public async Task<string> GenerateEncodedToken(string userName, ClaimsIdentity identity)
        {
            var claims = new List<Claim>()
            {
                 ...
                 identity.FindFirst(JwtUtils.Claims.Strings.JwtClaimIdentifiers.EALogin),
                 identity.FindFirst(JwtUtils.Claims.Strings.JwtClaimIdentifiers.IdPessoa),
                 identity.FindFirst(JwtUtils.Claims.Strings.JwtClaimIdentifiers.IdPais)
             };
        ...
        //public async Task<string> GenerateEncodedTokenAplicacao(string userName, ClaimsIdentity identity)
        //{
        //    var claims = new List<Claim>()
        //    {
        //        new Claim(JwtRegisteredClaimNames.Sub, userName),
        ...
        //public ClaimsIdentity GenerateClaimsIdentity(string login, string nomeCompleto, string email, string password, string celula, string uidNumber, List<int> celulasVisualizadas, string celulaTratada, string EALogin, string idPessoa = null, string idPais = null)
        //{
        //    return new ClaimsIdentity(new GenericIdentity(login, "Token"), new[]
        //    {
        //        new Claim(JwtUtils.Claims.Strings.JwtClaimIdentifiers.NomeCompleto, nomeCompleto),
        ...
        //        new Claim(JwtUtils.Claims.Strings.JwtClaimIdentifiers.CelulaTratada, celulaTratada),
        //        new Claim(JwtUtils.Claims.Strings.JwtClaimIdentifiers.UidNumber, uidNumber),
        //        new Claim(JwtUtils.Claims.Strings.JwtClaimIdentifiers.CelulasVisualizadas, celulasVisualizadas is not null ? string.Join(",", celulasVisualizadas) : ""),
        //        new Claim(JwtUtils.Claims.Strings.JwtClaimIdentifiers.EALogin,EALogin),
        //        idPessoa != null ? new Claim(JwtUtils.Claims.Strings.JwtClaimIdentifiers.IdPessoa,idPessoa) : null,
        //        idPais != null ? new Claim(JwtUtils.Claims.Strings.JwtClaimIdentifiers.IdPais,idPais) : null
        //    });
        //}

        //public ClaimsIdentity GenerateClaimsIdentityAplicacao(string login)
        //{
        //    return new ClaimsIdentity(new GenericIdentity(login, "Token"), new[]
        //    {
        //        new Claim(JwtUtils.Claims.Strings.JwtClaimIdentifiers.Login, login),
